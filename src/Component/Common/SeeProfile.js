...
const VehiclesSection = ({ transporterId }) => {
  ...
  useEffect(() => {
    axios.get(`${API_BASE_URL}/vehicles/user/${transporterId}`)
    ...
    axios.get(`${API_BASE_URL}/api/users/${id}`)
      .then(res => {
        ...
        if (res.data.role === "FARMER") {
          axios.get(`${API_BASE_URL}/products/user/${id}`)
    ...
    <div className="profile-container">
      ...
      <div className="farmer-info">
        <div className="card-top" style={{ display: "flex", justifyContent: "center" }}>
          {user.profilePic ? (
            <img className="profile-img" src={`${API_BASE_URL}/uploads/${user.profilePic}`} alt="profile" style={{ objectFit: "cover" }} />
          ) : (
