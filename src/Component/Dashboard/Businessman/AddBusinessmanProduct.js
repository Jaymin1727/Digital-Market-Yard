...
export const AddBusinessmanProduct = () => {
  ...
  const handleSold = (productId) => {
    navigate(`/businessman-product-detail/${productId}`);
  };
  ...
  return (
    <div className="add-product-container">
      ...
      <div className="add-product-card">
        ...
        <h1 className="title">
          {editId ? "✏ Update Product" : "📦 Add Business Product"}
        </h1>
...
export default AddBusinessmanProduct;
